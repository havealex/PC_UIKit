...
protected:
    ...
    void WindowClosing(VARIANT_BOOL bValue, VARIANT_BOOL *&bCancel);
...
public:
    ...
    virtual HRESULT STDMETHODCALLTYPE Exec(__RPC__in_opt const GUID *pguidCmdGroup, DWORD nCmdID, DWORD nCmdexecopt,
