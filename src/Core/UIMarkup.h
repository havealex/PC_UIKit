...
public:
    explicit CMarkup(LPCTSTR pstrXML = nullptr);
    ~CMarkup();
...
private:
    ...
    using XMLELEMENT = tagXMLELEMENT;

    LPTSTR m_pstrXML;
    XMLELEMENT *m_pElements;
    ULONG m_nElements;
    ULONG m_nReservedElements;
    TCHAR m_szErrorMsg[100] = { 0 };
    TCHAR m_szErrorXML[50] = { 0 };
...
private:
    ...
    int m_iPos;
    int m_nAttributes;
    XMLATTRIBUTE m_aAttributes[MAX_XML_ATTRIBUTES] = { 0 };
    CMarkup *m_pOwner;
};
} // namespace DuiLib
