...
void CContainerUI::ProcessScrollBar(RECT rc, int cxRequired, int cyRequired)
{
    ...
    rcScaledPadding.top = DuiLib::CResourceManager::GetInstance()->Scale(m_rcScrollBarPadding.top);
    rcScaledPadding.left = DuiLib::CResourceManager::GetInstance()->Scale(m_rcScrollBarPadding.left);
    rcScaledPadding.bottom = DuiLib::CResourceManager::GetInstance()->Scale(m_rcScrollBarPadding.bottom);
    rcScaledPadding.right = DuiLib::CResourceManager::GetInstance()->Scale(m_rcScrollBarPadding.right);
