...
public:
    ...
    void ForceNotifyPump(TNotifyUI &msg);
...
public:
    ...
    void Center2ParentWindow();
    void SetMsgLoop(bool bMsgLoop);
...
protected:
    ...
    bool m_bSubclassed;
    bool m_bPopup = false;
    bool m_inModal = false;
    HICON bigIcon = nullptr;
    HICON smallIcon = nullptr;
    bool m_bMsgLoop = true;
