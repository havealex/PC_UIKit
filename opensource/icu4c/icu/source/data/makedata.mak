...
$(COREDATA_TS):
	...
	copy "$(ICUMAKE)\locales\ja_JP.txt" "$(ICUMAKE)\curr\ja_JP.txt"
...
"$(ICU_LIB_TARGET)" : $(COMMON_ICUDATA_DEPENDENCIES) "$(ICUDATA_SOURCE_ARCHIVE)"
	...
	copy "$(ICUP)\cutout_icudata\icudata.lst" "$(ICUTMP)\icudata.lst"
	copy "$(ICUBLD_PKG)\ja_JP.res" "$(ICUBLD_PKG)\curr\ja_JP.res"
